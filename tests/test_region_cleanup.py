...
def test_region_worker_params_from_pipeline_requests_match_builders():
    train_rids = {"read1"}
    ...
    assert region_pipeline._region_bam_worker_params_from_request(
        bam_request,
        return_posteriors=True,
    ) == region_pipeline._region_bam_worker_params(
        edge_trim=11,
        circular=True,
        mode="daf",
        context_size=5,
    ...
    assert region_pipeline._fused_region_worker_params_from_request(
        fused_request,
    ) == region_pipeline._fused_region_worker_params(
        edge_trim=12,
        circular=False,
        mode="pacbio-fiber",
        context_size=6,
